app.controller('referCtrl', function($scope, $ionicHistory, $timeout, $ionicLoading, $cordovaSocialSharing) {
    ...
    $scope.OtherShare = function() {
        $scope.custName = window.localStorage.getItem('userName');
        var sharemsg = 'Hi, This is '+$scope.custName+'. I just gifted education to a girl child by posting a property review. Use my code '+$scope.userReferralCode+' to join Roofpik today.';
